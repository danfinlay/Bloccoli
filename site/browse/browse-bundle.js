...
var request = require('../node_modules/browser-request');

request('/browse.json', function(er, res){
  if(er){
    alert("There was a problem fetching the project list: "+er);
  }else{
    console.log("Response: "+JSON.stringify(res));
    var entries = JSON.parse(res._object.response);
    $entries = $('#entries');

    entries.forEach(function(entry){
      var entryHtml = '<div class="entry"><a href="/programs/'+entry.key;
      entryHtml += '"><span class="entryTitle">'+entry.title+'</span></a><br><span class="entryDescription">'+entry.description+'</span></div><br>';
      $entries.append(entryHtml);
    });
  }
})
},{"../node_modules/browser-request":2}],2:[function(require,module,exports){
// Browser Request
//
